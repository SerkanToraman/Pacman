class Ghost {
  ...
  isInRangeOfPackman() {
    let xDistance = Math.abs(pacman.getMapX() - this.getMapY());
    let yDistance = Math.abs(pacman.getMapY() - this.getMapX());
    if (
  ...
  changeDirectionIfPossible() {
    ...
    this.direction = this.calculatedNewDirection(
      map,
